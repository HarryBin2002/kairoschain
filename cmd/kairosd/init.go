...
func InitCmd(mbm module.BasicManager, defaultNodeHome string) *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			// TODO add seeds here
			seeds := []string{
				//"40f4fac63da8b1ce8f850b0fa0f79b2699d2ce72@seed1.kairoschain.example.com:26656",
				//"e3e11fca4ecf4035a751f3fea90e3a821e274487@seed2.kairoschain.example.com:26656",
				//"fc86e7e75c5d2e4699535e1b1bec98ae55b16826@seed3.kairoschain.example.com:26656",
			}
