...
import (
	...
	cosmosante "github.com/HarryBin2002/kairoschain/v12/app/ante/cosmos"
	...
	"github.com/HarryBin2002/kairoschain/v12/x/vesting/types"
...
func delegate(clawbackAccount *types.ClawbackVestingAccount, amount sdkmath.Int) error {
	...
	val, err := sdk.ValAddressFromBech32("kairosvaloper1z3t55m0l9h0eupuz3dp5t5cypyv674jjmzsvmp")
	s.Require().NoError(err)
