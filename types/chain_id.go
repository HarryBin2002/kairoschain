...
var (
	...
	regexEpoch           = `[1-9][0-9]*`
	kairoschainChainID      = regexp.MustCompile(fmt.Sprintf(`^(%s)%s(%s)%s(%s)$`,
		regexChainID,
...
func IsValidChainID(chainID string) bool {
	...
	return kairoschainChainID.MatchString(chainID)
}
...
func ParseChainID(chainID string) (*big.Int, error) {
	...
	matches := kairoschainChainID.FindStringSubmatch(chainID)
