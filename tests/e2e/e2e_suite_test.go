...
import (
	...
	"github.com/HarryBin2002/kairoschain/v12/tests/e2e/upgrade"
)

const (
	// defaultManagerNetwork defines the network used by the upgrade manager
	defaultManagerNetwork = "kairoschain-local"
...
// runNodeWithCurrentChanges builds a docker image using the current branch of the Kairoschain repository.
...
func (s *IntegrationTestSuite) proposeUpgrade(name, target string) {
	...
	// if Kairoschain is based on Evmos lower than v10.x.x no need to use the legacy proposal
