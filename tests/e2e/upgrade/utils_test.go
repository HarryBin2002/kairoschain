...
// TestVersionsLess tests the KairoschainVersion type's Less method with
// different version strings
func TestVersionsLess(t *testing.T) {
	var version KairoschainVersion
...
// TestVersionsSwap tests the KairoschainVersion type's Swap method
...
// TestVersionsLen tests the KairoschainVersion type's Len method
func TestVersionsLen(t *testing.T) {
	var version KairoschainVersion = []string{"v9.1.0", "v10.0.0"}
