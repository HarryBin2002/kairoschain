...
// EthereumAPI allows applications to connect to an Kairoschain node that is
// part of the Kairoschain blockchain. Developers can interact with on-chain EVM data
