...
import (
	...
	ante "github.com/HarryBin2002/kairoschain/v12/app/ante"
...
func (suite *AnteTestSuite) SetupTest() {
	...
	suite.app = app.EthSetup(checkTx, func(app *app.Kairoschain, genesis simapp.GenesisState) simapp.GenesisState {
	...
	// set staking denomination to Kairoschain denom
