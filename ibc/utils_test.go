...
func TestGetTransferSenderRecipient(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "cosmos1",
						Receiver: "kairos1x2w87cvt5mqjncav4lxy8yfreynn273xx7q2u6",
						Amount:   "123456",
					},
				),
			},
		...
		{
			"valid - cosmos sender, kairoschain recipient",
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "cosmos1qql8ag4cluz6r4dz28p3w00dnc9w8ueulg2gmc",
			...
			"kairos1x2w87cvt5mqjncav4lxy8yfreynn273xx7q2u6",
			false,
		},
		{
			"valid - kairoschain sender, cosmos recipient",
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
						Sender:   "kairos1x2w87cvt5mqjncav4lxy8yfreynn273xx7q2u6",
		...
		{
			"valid - osmosis sender, kairoschain recipient",
			channeltypes.Packet{
				Data: transfertypes.ModuleCdc.MustMarshalJSON(
					&transfertypes.FungibleTokenPacketData{
