...
import (
	...
	"github.com/HarryBin2002/kairoschain/v12/utils"
)
...
func GetTransferSenderRecipient(packet channeltypes.Packet) (
	...
	sender, err = utils.GetKairoschainAddressFromBech32(data.Sender)
	if err != nil {
	...
	recipient, err = utils.GetKairoschainAddressFromBech32(data.Receiver)
	if err != nil {
